...
import { on } from "../@reflex/virtual-dom.js"
import {
  doc,
  node,
  body,
...
import { fx, nofx } from "../@reflex/fx.js"
import { never } from "../@reflex/basics.js"
import * as ProfileFX from "./Profile/Effect.js"
import * as Data from "./Profile/Data.js"
import * as Inbox from "./Profile/Inbox.js"
import * as Decoder from "./Profile/Decoder.js"
...
export const init = (data /*:Data.ProfileData*/) => {
...
const page = (title /*:string*/, main) => doc(title, body([], [main]))

export const view = (state /*:Profile*/) => {
  switch (state.tag) {
    case "LoadingProfile": {
