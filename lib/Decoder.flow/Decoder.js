...
export const Float = new class AFloat /*::implements Decoder<mixed, float>*/ {
...
const $stringTag /*:any*/ = $Symbol.toStringTag

const toStringTag = (value /*:any*/) /*:string*/ => {
  switch (value) {
    case null: {
      return "null"
    }
...
export const ArrayBuffer = new class ArrayBufferDecoder /*::implements Decoder<mixed, DOM.ArrayBuffer>*/ {
  decode(input /*: mixed*/) /*: Decode<DOM.ArrayBuffer>*/ {
    if (input instanceof ArrayBuffer) {
      return input
    } else {
      const output /*:any*/ = input
      switch (toStringTag(input)) {
        case "ArrayBuffer": {
          return output
        }
        ...
        default: {
          return new ValueError("ArrayBuffer", input)
        }
      }
    }
  }
...
export const Blob = new class BlobDecoder /*::implements Decoder<mixed, DOM.Blob>*/ {
  decode(input /*: mixed*/) /*: Decode<DOM.Blob>*/ {
    if (input instanceof ArrayBuffer) {
      return input
    } else {
      const output /*:any*/ = input
      switch (toStringTag(input)) {
        ...
        default: {
          return new ValueError("Blob", input)
        }
      }
    }
  }
...
export const File = new class FileDecoder /*::implements Decoder<mixed, DOM.File>*/ {
  decode(input /*: mixed*/) /*: Decode<DOM.File>*/ {
    if (input instanceof ArrayBuffer) {
      return input
    } else {
      const output /*:any*/ = input
      switch (toStringTag(input)) {
        ...
        default: {
          return new ValueError("File", input)
        }
      }
    }
  }
...
class IterableDecoder /*::<a> implements Decoder<mixed, a[]>*/ {
  /*::
  decoder: Decoder<mixed, a>
  */
  constructor(decoder /*: Decoder<mixed, a>*/) {
  ...
  decode(input /*: mixed*/) /*:Decode<a[]>*/ {
    const iterator = this.toArray(input)
    if (iterator) {
      let index = 0
      const array = []
      const { decoder } = this
      ...
      return new ValueError("Iterable", input)
    }
  }
}

export const iterable = /*::<a>*/ (
  decoder /*: Decoder<mixed, a>*/
) /*: Decoder<mixed, a[]>*/ => new IterableDecoder(decoder)
